    ...
    <div class="value">
        <div class="input-container">
            <div class="input-time">
                ...
                〜
                <input class="input__time" type="time" name="clock_out"
                    value="{{ $work->clock_out?->format('H:i') }}">
            </div>
            @error('clock_in')
    ...
    @foreach ($breaks as $i => $break)
        <div class="row">
            ...
            <div class="value">
                <div class="input-container">
                    <div class="input-time">
                        <input class="input__time" type="time" name="break_start[{{ $i }}]"
                            value="{{ optional($break->break_start)->format('H:i') }}">
                        〜
                        <input class="input__time" type="time" name="break_end[{{ $i }}]"
...
{{ $work->application->reason ?? '' }}@else{{ old('reason') }}
@endif
</textarea>
            @error('reason')
                <p class="error-message">{{ $message }}</p>
